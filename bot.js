(async () => {
  ...
  const TEXTS = {
    title: "WPlace Tự Động Vẽ",
    initBot: "Khởi Động Bot",
    ...
    colorsFound: "✅ Đã tìm thấy {count} màu có sẵn",
    loadingImage: "🖼️ Đang tải hình ảnh...",
    imageLoaded: "✅ Đã tải hình ảnh với {count} điểm ảnh hợp lệ",
    imageError: "❌ Lỗi khi tải hình ảnh",
    selectPositionAlert: "Hãy vẽ điểm ảnh đầu tiên tại vị trí bạn muốn bắt đầu vẽ tranh!",
    waitingPosition: "👆 Đang chờ bạn vẽ điểm ảnh tham chiếu...",
    positionSet: "✅ Đã thiết lập vị trí thành công!",
    positionTimeout: "❌ Hết thời gian chờ chọn vị trí",
    startPaintingMsg: "🎨 Bắt đầu vẽ...",
    paintingProgress: "🧱 Tiến độ: {painted}/{total} điểm ảnh...",
    noCharges: "⌛ Hết lượt vẽ. Đang chờ {time}...",
    paintingStopped: "⏹️ Đã dừng vẽ theo yêu cầu",
    paintingComplete: "✅ Hoàn thành! Đã vẽ {count} điểm ảnh.",
    paintingError: "❌ Lỗi trong quá trình vẽ",
    missingRequirements: "❌ Vui lòng tải hình ảnh và chọn vị trí trước",
    progress: "Tiến độ",
    pixels: "Điểm ảnh",
    charges: "Lượt vẽ",
    estimatedTime: "Thời gian ước tính",
    initMessage: "Nhấn 'Khởi Động Bot' để bắt đầu",
    waitingInit: "Đang chờ khởi động...",
    resizeSuccess: "✅ Đã thay đổi kích thước thành {width}x{height}",
